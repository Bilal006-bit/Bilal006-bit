...
## 🔭 What I do
- Design and build ETL/data pipelines and backend APIs using Python and SQLAlchemy.
- Produce data visualizations and dashboards for exploratory analysis and storytelling.
- Deploy and operate apps (Docker, AWS — deployment experience).
...
Open to roles or collaborations in data engineering, backend development, and analytics projects. Available for freelance and full-time opportunities.
